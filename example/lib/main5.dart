...
// When the MaterialApp is disposed the bloc is killed, and for this reasion only child widgets can access to the BloC
//
// In this case you do not have to use:
// final counterBloc = BlocProvider.of<CounterBloc>(context);
// To try this approach comment all the "BlocProvider.of" methods bellow.
*/
