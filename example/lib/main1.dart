...
class CounterBloc extends StatesRebuilder {
  ...
  void increment1() {
    ...
    rebuildStates([CounterStates.myCounter]);
      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            StateBuilder(
              stateID: CounterStates.myCounter,
              blocs: [counterBloc],
            ...
            StateBuilder(
              builder: (State state) => Column(
                    children: <Widget>[
                      ...
                      (counterBloc.counter1 % 2 == 0) ? Race() : Text("1")
                    ],
                  ),
            ),
          ],
...
class Race extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StateBuilder(
      stateID: "race",
      blocs: [counterBloc],
      builder: (_) => Text("${counterBloc.counter1 + counterBloc.counter2}"),
    );
  }
}
