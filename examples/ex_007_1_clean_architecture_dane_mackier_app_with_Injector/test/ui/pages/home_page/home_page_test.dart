...
void main() {
  ...
  setUp(() {
    ...
    homePage = Injector(
      inject: [
        ...
        Inject<PostsService>(() => FakePostsService()),
      ],
      builder: (_) => MaterialApp(
        routes: {
          ...
          'post': (context) {
            ...
            return Scaffold(
                body: Text('This is post detail page is displayed'));
          },
        },
  ...
  testWidgets(
    ...
    (Injector.get<PostsService>() as FakePostsService).error =
  ...
  testWidgets('Navigate to post detail and increment likes after pop back ',
    ...
    ReactiveModel<PostsService>().setState((s) => s.incrementLikes(1));
