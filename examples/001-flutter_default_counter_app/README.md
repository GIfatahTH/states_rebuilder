...
* In a similar fashion as used in Flutter, ReactiveModel keys are used to control a ReactiveModel from outside the widget where it is created, ReactiveModel key inherited all the state and behavior of the ReactiveModel is is associated with.
