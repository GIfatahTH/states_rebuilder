    ...
    () {
      ...
      test(
        ...
        () async {
          ...
          todoService.addTodo(todoToAdd).listen((event) {
      ...
      test(
        ...
        () async {
          ...
          todoService.updateTodo(Todo('updateTodo', id: '1')).listen(
            (event) {
              final afterUpdate =
                  todoService.todos.firstWhere((todo) => todo.id == '1');
      ...
      test(
        ...
        () async {
          await todoService.loadTodos();
          expect(todoService.todos.length, equals(3));
          todoService.deleteTodo(Todo('updateTodo', id: '1')).listen(
            (event) {
              expect(todoService.todos.length, equals(2));
            },
            onDone: () {
      ...
      test(
        ...
        () async {
          ...
          todoService.toggleAll().listen((event) {
      ...
      test(
        ...
        () async {
          ...
          todoService.clearCompleted().listen((event) {
            expect(todoService.todos.length, equals(2));
            expect(todoService.numActive, equals(2));
            expect(todoService.numCompleted, equals(0));
          }, onDone: () {
