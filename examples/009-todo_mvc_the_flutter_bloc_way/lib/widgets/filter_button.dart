...
class FilterButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return StateBuilder<FilteredTodosState>(
        ...
        builder: (BuildContext context, filteredTodosStateRM) {
          final button = _Button(
            onSelected: (filter) {
              filteredTodosStateRM.setState(
                (s) => FilteredTodosLoaded.updateFilter(s, filter),
              );
            },
            activeFilter: filteredTodosStateRM.state is FilteredTodosLoaded
                ? (filteredTodosStateRM.state as FilteredTodosLoaded)
                    .activeFilter
