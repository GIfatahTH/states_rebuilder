...
void main() {
  ...
  testWidgets(
    'Injector  will not stream dispose if the injector not disposed',
    (tester) async {
      Model model = Model();
      bool switcher = true;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pump();
      expect(Scaffold.of(context0), isNotNull);
      isTrue = false;
      vm.rebuildStates();
      model1.setState(null, onSetState: (context) {
        context0 = context;
      ...
      await tester.pump();
      expect(Scaffold.of(context0), isNotNull);
      expect(context2, equals(context1));
    },
  );
