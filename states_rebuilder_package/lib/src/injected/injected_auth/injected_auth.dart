...
// class InjectedAuthImp1<T, P> extends InjectedController<T>
...
//   void Function(T? s)? initialized;
//   void Function(T s)? disposed;
//   SnapState<T>? Function(MiddleSnapState<T> middleSnap)? middleSnap;
//   PersistState<T> Function()? persister;
//   @override
...
//   @override
//   SnapState<T>? middleSnapState(MiddleSnapState<T> snap) {
//     return middleSnap?.call(snap);
//   }
//   @override
//     PersistState<T> Function()? get persist => persister;
