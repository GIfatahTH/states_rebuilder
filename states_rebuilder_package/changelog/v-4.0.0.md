        ...
        onGenerateRoute: RM.navigate.onGenerateRoute(
          {
            ...
            Page2.routeName: (c) => Page2(),
            Page3.routeName: (c) => Page3(),
          },
    ...
    onGenerateRoute: RM.navigate.onGenerateRoute({
      ...
      '/posts': (c) => RouteWidget(
            routes: {
              ...
              '/postDetails': (c) => PostDetailsWidget(),
            },
          ),
...
return MaterialApp(
    ...
    onGenerateRoute: RM.navigate.onGenerateRoute({
      '/dashboard': (c) => RouteWidget(
          ...
          routes: {
            '/': (c) => OverviewWidget(),
            newUsers: (c) => RouteWidget(
                  builder: (c) => NewUsersWidget(),
                  routes: {
                    '/:id': (c) => UserDetailWidget(),
                  },
                ),
            sales: (c) => SalesWidget(),
          },
