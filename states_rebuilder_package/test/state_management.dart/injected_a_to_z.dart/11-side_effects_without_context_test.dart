...
void main() {
  testWidgets('If no states_rebuilder widget is used return null', (
    tester,
  ) async {
    final widget = MaterialApp(home: Text(model.state.toString()));
  ...
  testWidgets('get BuildContext, navigatorState and showDialog', (
    tester,
  ) async {
  ...
  testWidgets('get ScaffoldState from setStat ', (tester) async {
    final widget = MaterialApp(
      home: Scaffold(
        body: OnBuilder(
          listenTo: model,
  ...
  testWidgets('get ScaffoldState from StateBuilder ', (tester) async {
    final widget = MaterialApp(
      home: Scaffold(
        body: OnBuilder.data(
          listenTo: model,
          builder: (c) => Text(model.state.toString()),
        ),
      ),
    );
