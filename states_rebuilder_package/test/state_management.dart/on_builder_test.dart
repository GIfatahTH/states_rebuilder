...
void main() {
  testWidgets('OnBuilder On()', (tester) async {
    final model = 0.inj();
    final Widget widget = Directionality(
      ...
      child: OnBuilder(
        ...
        builder: () => Text(model.state.toString()),
  ...
  testWidgets('OnBuilder list On()', (tester) async {
    final model = 0.inj();
    final Widget widget = Directionality(
      textDirection: TextDirection.ltr,
      child: OnBuilder(
  ...
  testWidgets('OnBuilder On.All()', (tester) async {
  ...
  testWidgets('OnBuilder list On.or()', (tester) async {
  ...
  testWidgets('Test OnFutureBuilder functionality', (tester) async {
    bool shouldThrow = false;
    final future1 = RM.injectFuture(() async {
  ...
  testWidgets('Test OnStreamBuilder functionality', (tester) async {
  ...
  testWidgets('WHEN generic type is given for OnBuilder with many listeners'
  ...
  testWidgets('WHEN generic type is not given for OnBuilder with many listeners'
      'THEN the model that emits the notification is exposed', (tester) async {
    final model1 = 0.inj();
    final model2 = true.inj();
    var exposedModel;
    int numberOfRebuild = 0;
  ...
  testWidgets('Text OnBuilder.create'
      'THEN', (tester) async {
  ...
  testWidgets('WHEN no listener is defined'
      'THEN throws assertion error', (tester) async {
    expect(() => OnBuilder(builder: () => Container()), throwsAssertionError);
    expect(
      () => OnBuilder.data(builder: (c) => Container()),
      throwsAssertionError,
    );
    expect(
      () => OnBuilder.all(
        onWaiting: () => Container(),
        onError: (c, __) => Container(),
        onData: (c) => Container(),
      ),
      throwsAssertionError,
    );
    expect(
      () => OnBuilder.orElse(orElse: (c) => Container()),
      throwsAssertionError,
    );
  });

  testWidgets('WHEN OnBuilder.data is used'
  ...
  testWidgets('test OnBuilder.create', (tester) async {
  ...
  testWidgets('Test onData of OnBuilder.orElse', (tester) async {
  ...
  testWidgets('Test onBuilder.bindingObserver', (tester) async {
    List<Locale>? locales;
