...
void main() {
  ...
  testWidgets('OnReactive get injected model from state and listens to them', (
    tester,
  ) async {
  ...
  testWidgets('OnReactive with isWaiting can get observers'
      'THEN', (tester) async {
    final counter = 0.inj();
  ...
  testWidgets('OnReactive with hasError can get observers'
      'THEN', (tester) async {
    final counter = 0.inj();
    final counter2 = RM.inject(() => 0);
  ...
  testWidgets('OnReactive with onAll can get observers', (tester) async {
    final counter = 0.inj();
    final counter2 = RM.inject(() => 0);
  ...
  testWidgets('OnReactive with onOr can get observers', (tester) async {
    final counter = 0.inj();
    final counter2 = RM.inject(() => 0);
  ...
  testWidgets('Check onSetState', (tester) async {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final counter1 = RM.inject(
        () => 0,
        sideEffects: SideEffects(dispose: () => isDisposed1 = true),
      );
      final counter2 = RM.inject(
        () => 0,
        sideEffects: SideEffects(dispose: () => isDisposed2 = true),
      );
      final counter3 = 0.inj();
      //
      final widget = OnReactive(() {
  ...
  testWidgets('WHEN ReactiveStateless is used above MaterialApp'
      'THEN it will not register states child to MaterialApp', (tester) async {
    final widget = OnReactive(() => MaterialApp(home: _Widget1()));
    await tester.pumpWidget(widget);
        ...
        home: OnReactive(
          () => CustomScrollView(
            slivers: [
              ...
              SliverAppBar(title: _Widget1()),
              SliverList(delegate: SliverChildListDelegate([_Widget1()])),
              SliverGrid(
...
class _ParentWidget extends ReactiveStatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [_Widget1(), _Widget2(), _Widget3()],
    );
  }
}
...
class _Widget3 extends StatelessWidget {
  const _Widget3({Key? key}) : super(key: key);
