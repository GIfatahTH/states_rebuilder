...
//
final computedCounter = RM.injectComputed<String>(
  compute: (String oldState) {
    numberOfComputeCall++;
  ...
  shouldCompute: (String state) => int.parse(state) < 5 && counter1.state < 50,
