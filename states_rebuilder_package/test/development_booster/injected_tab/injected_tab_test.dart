...
void main() {
  ...
  final injectedTab = RM.injectTabPageView(initialIndex: 2, length: 5);
  final views = [
    Text('TabView0'),
    Text('TabView1'),
    Text('TabView2'),
  ...
  testWidgets('injectedTab basic functionality', (tester) async {
    ...
    final widget = MaterialApp(
      home: Scaffold(
        ...
        bottomNavigationBar: OnTabPageViewBuilder(
          // listenTo: injectedTab,
          builder: (index) =>
              TabBar(controller: injectedTab.tabController, tabs: tabs),
        ),
      ),
    );
    //
  ...
  testWidgets('InjectedTab.animateTo works', (tester) async {
    final widget = MaterialApp(
      home: Scaffold(
        body: injectedTab.rebuild.onTabPageView((index) {
          return TabBarView(
            controller: injectedTab.tabController,
            children: views,
          );
        ...
        bottomNavigationBar: injectedTab.rebuild.onTabPageView(
          (index) => TabBar(controller: injectedTab.tabController, tabs: tabs),
        ),
      ),
    );
  ...
  testWidgets('OnTabBuilder', (tester) async {
    final injectedTab = RM.injectTabPageView(length: 5);
    late int currentIndex;
      ...
      home: Scaffold(
        ...
        bottomNavigationBar: OnTabPageViewBuilder(
          ...
          builder: (c) {
            ...
            return TabBar(controller: injectedTab.tabController, tabs: tabs);
          },
        ),
      ),
    );
  ...
  testWidgets('Test when only PageController is defined', (tester) async {
    final widget = MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: OnBuilder(
  ...
  testWidgets('Test when only TabController is defined', (tester) async {
    final widget = MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: OnBuilder(
  ...
  testWidgets('Test when both PageController and TabController are defined', (
    tester,
  ) async {
    final widget = MaterialApp(
      home: Scaffold(
        ...
        bottomNavigationBar: OnTabPageViewBuilder(
          ...
          builder: (index) => TabBar(
            ...
            tabs: tabs
                ...
                .map(
                  (i, e) =>
                      MapEntry(i, index == i ? Text('Selected tab: $i') : e),
                )
                .values
                .toList(),
          ),
  ...
  testWidgets('WHEN fails to implicitly refer the InjectedTabPageView'
      'AND when it is not explicitly defined'
      'THEN throws an assertion error', (tester) async {
