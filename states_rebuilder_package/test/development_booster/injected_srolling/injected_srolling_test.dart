...
void main() {
  ...
  testWidgets('WHEN InjectedScrolling is associated with a listView'
    ...
    final widget = MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          title: scroll.rebuild.onScroll((scroll) {
  ...
  testWidgets('Test scrolling flags forward direction'
      'THEN', (tester) async {
  ...
  testWidgets('Test scrolling flags forward and revers direction'
      'THEN', (tester) async {
    final animation = RM.injectAnimation(
      duration: Duration(seconds: 1),
      upperBound: 600,
