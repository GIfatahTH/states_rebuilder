...
void main() {
  testWidgets('WHEN two double , AlignmentGeometry, tow EdgeInsetsGeometry, constraints, color and  decoration are fined'
      'THEN they are implicitly animated', (tester) async {
    bool selected = false;
    double? height;
    double? width;
        ...
        builder: () => OnAnimationBuilder(
          ...
          builder: (animate) {
            return Container(
              ...
              constraints: constraints = animate(
                selected
              ...
              foregroundDecoration: decoration = animate(
                selected
  ...
  testWidgets('WHEN  AlignmentGeometry, tow EdgeInsetsGeometry, constraints, color and  decoration are fined'
      ...
      'THEN the app works', (tester) async {
    bool selected = false;
    ...
    await tester.pumpWidget(
      animation.rebuild.onAnimation((animate) {
        return Container(
          padding: padding = animate(selected ? EdgeInsets.all(100) : null),
          margin: margin = animate(
            selected ? null : EdgeInsets.all(10),
            'margin',
          ),
          alignment: alignment = animate(selected ? Alignment.topLeft : null),
          constraints: constraints = animate(
            selected ? null : BoxConstraints(maxHeight: 100, maxWidth: 100),
          ),
          color: color = animate(selected ? null : Colors.red),
          foregroundDecoration: decoration = animate(
            selected ? BoxDecoration(color: Colors.white) : null,
          ),
          child: Container(),
        );
      }),
  ...
  testWidgets('WHEN two variable of the same type and same name are used'
    ...
    await tester.pumpWidget(
      OnAnimationBuilder(
        listenTo: animation,
        builder: (animate) {
          return SizedBox(width: animate(100)!, height: animate(50)!);
        },
      ),
    );
  ...
  testWidgets('WHEN repeats is 2'
      'THEN animation repeats two times and stop', (tester) async {
    ...
    final widget = OnAnimationBuilder(
      ...
      builder: (animate) => Container(
        width: width = animate.fromTween((c) => Tween(begin: 0.0, end: 100.0))!,
      ),
    );
  ...
  testWidgets('WHEN repeats is 2 and  shouldReverseRepeats is true'
      'THEN animation cycle two times and stop', (tester) async {
    int endAnimationNum = 0;
    final animation = RM.injectAnimation(
      duration: Duration(seconds: 1),
      repeats: 3,
  ...
  testWidgets('WHEN repeats is 2, and animation starts form upper bound.'
      'THEN animation repeats two times and stop', (tester) async {
    int endAnimationNum = 0;
    final animation = RM.injectAnimation(
      initialValue: 1,
  ...
  testWidgets('WHEN setCurve is defined for a particular value'
      'THEN it override the default Curve'
      'Case animate.call', (tester) async {
    ...
    final widget = OnAnimationBuilder(
      ...
      builder: (animate) {
        ...
        value1 = animate
            .setCurve(Interval(0, 0.5))
            .call(isSelected ? 0 : 100, 'value1')!;
        value2 = animate
            .setCurve(Interval(0.5, 1))
            .call(isSelected ? 0 : 100, 'value2')!;
        return Container();
      },
    );
    await tester.pumpWidget(widget);
  ...
  testWidgets('WHEN setReversCurve is defined for a particular value'
      'THEN it override the default Curve'
      'Case animate.call', (tester) async {
    bool isSelected = true;
    final animation = RM.injectAnimation(
    ...
    final widget = OnAnimationBuilder(
      ...
      builder: (animate) {
        value0 = animate(isSelected ? 0 : 100)!;
        value1 = animate
            .setReverseCurve(Interval(0, 0.5))
            .call(isSelected ? 0 : 100, 'value1')!;
        value2 = animate
            .setReverseCurve(Interval(0.5, 1))
            .call(isSelected ? 0 : 100, 'value2')!;
        return Container();
      },
    );
  ...
  testWidgets('WHEN setCurve is defined for a particular value'
      'THEN it override the default Curve'
      'Case animate.fromTween', (tester) async {
    final animation = RM.injectAnimation(
      duration: Duration(seconds: 1),
      shouldAutoStart: true,
    );
    ...
    final widget = OnAnimationBuilder(
      listenTo: animation,
      builder: (animate) {
        value0 = animate.fromTween((c) => Tween(begin: 0, end: 100))!;
        value1 = animate
            .setCurve(Interval(0, 0.5))
            .fromTween((c) => Tween(begin: 0, end: 100), 'value1')!;
        value2 = animate
            .setCurve(Interval(0.5, 1))
            .fromTween((c) => Tween(begin: 0, end: 100), 'value2')!;
        return Container();
      },
    );
    await tester.pumpWidget(widget);
  ...
  testWidgets('Animation can be used with per built flutter transition widget'
      'Animation is triggered using triggerAnimation method', (tester) async {
    final animation = RM.injectAnimation(
      duration: Duration(seconds: 1),
      shouldAutoStart: true,
    );
  ...
  testWidgets('test various tweens'
      'THEN', (tester) async {
    bool isSelected = true;
          ...
          OnAnimationBuilder(
            ...
            builder: (animate) {
              return SizedBox.fromSize(
                size: size = animate(isSelected ? Size.zero : Size(10, 10))!,
              );
            },
          ),
          OnAnimationBuilder(
  ...
  testWidgets('test various tweens extension', (tester) async {
    final animation = RM.injectAnimation(
      duration: Duration(seconds: 1),
      shouldAutoStart: true,
    );
      ...
      Column(
        children: [
          ...
          OnAnimationBuilder(
            listenTo: animation,
            builder: (animate) {
              _double = animate.fromTween((c) => 0.0.tweenTo(10.0))!;
              color = animate.fromTween(
                (c) => Colors.red.tweenTo(Colors.blue),
              )!;
              alignmentGeometry = animate.fromTween(
                (c) => Alignment.topLeft.tweenTo(Alignment.topRight),
              )!;
              edgeInsetsGeometry = animate.fromTween(
                (c) => EdgeInsets.all(0).tweenTo(EdgeInsets.all(10)),
              )!;
              ...
              rect = animate.fromTween(
                (c) => Rect.zero.tweenTo(Rect.fromLTRB(10, 10, 10, 10)),
              )!;

              relativeRect = animate.fromTween(
                (c) => RelativeRect.fromLTRB(
                  0,
                  0,
                  0,
                  0,
              ...
              _int = animate.fromTween((c) => 0.tweenTo(10))!;

              borderRadius = animate.fromTween(
                (c) => BorderRadius.zero.tweenTo(BorderRadius.circular(10)),
              )!;

              themeData = animate.fromTween(
                (c) => ThemeData.dark().tweenTo(ThemeData.light()),
              )!;
  ...
  testWidgets('Test tween can not ne inferred'
      'THEN', (tester) async {
    final animation = RM.injectAnimation(duration: Duration(seconds: 1));
  ...
  testWidgets('throw an ArgumentError if two animate of the same type and name'
      'Case animate is defined inside a Builder', (tester) async {
    final animation = RM.injectAnimation(duration: Duration(seconds: 1));
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Do not throw an argument error'
  ...
  testWidgets('Nested animation inside ListView Builder works', (tester) async {
    final animation = RM.injectAnimation(
      duration: Duration(seconds: 1),
      repeats: 2,
      shouldReverseRepeats: true,
                  ...
                  itemBuilder: (c, __) {
                    ...
                    return OnAnimationBuilder(
                      ...
                      builder: (animate) {
                        height = selected
                            ? animate.fromTween(
                                (c) => Tween(begin: 0, end: 100.0),
                                'n',
                              )!
                            : animate.fromTween(
                                (c) => Tween(begin: 0.0, end: 100.0),
                                'n',
                              )!;
                        return Container();
                      },
  ...
  testWidgets('Check curvedAnimation getter', (tester) async {
    final animation = RM.injectAnimation(
      duration: Duration(seconds: 1),
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: OnAnimationBuilder(
          listenTo: animation,
          builder: (animate) {
            animate.fromTween((c) => Tween(begin: 0.0, end: 1.0))!;
            return Container();
          },
        ),
      ),
  ...
  testWidgets('reset Duration, reverseDuration and shouldReverseRepeats', (
    tester,
  ) async {
    final animation = RM.injectAnimation(
      duration: Duration(seconds: 1),
    ...
    await tester.pumpWidget(
      MaterialApp(
        home: OnAnimationBuilder(
          listenTo: animation,
          builder: (animate) {
            value = animate.fromTween((c) => Tween(begin: 0.0, end: 100.0))!;
            return Container();
          },
        ),
      ),
  ...
  testWidgets('reset repeats count', (tester) async {
    final animation = RM.injectAnimation(
      duration: Duration(seconds: 1),
      shouldAutoStart: true,
      repeats: 3,
  ...
  testWidgets('reset curve and reverse curve', (tester) async {
    final animation = RM.injectAnimation(duration: Duration(seconds: 1));
    late double value;
    late double value2;
    await tester.pumpWidget(
  ...
  testWidgets('issue #267', (WidgetTester tester) async {
    final animation = RM.injectAnimation(duration: const Duration(seconds: 1));
    double to = 0;
    double? width;
    final inj = false.inj();
    final widget = OnBuilder(
  ...
  testWidgets('Test duration extensions', (tester) async {
  ...
  testWidgets('WHEN begin and end tween are equal', (tester) async {
    final animation = RM.injectAnimation(
      duration: 1.seconds,
      shouldAutoStart: true,
    );
