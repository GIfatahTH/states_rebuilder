...
void main() {
  testWidgets('#260', (tester) async {
    final navigator = RM.injectNavigator(
      routes: {
        '/': (data) => const Text('/'),
        '/page1': (data) => RouteWidget(builder: (c) => const Text('/page1')),
        '/page2': (data) => RouteWidget(
          routes: {
            '/': (data) => RouteWidget(builder: (c) => const Text('/page2')),
            '/page21': (data) =>
                RouteWidget(builder: (c) => const Text('/page21')),
          },
        ),
      },
    );
