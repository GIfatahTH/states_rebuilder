...
void main() {
  ...
  testWidgets('WHEN RM.navigate.pageRouteBuilder is defined'
    ...
    RM.navigate.pageRouteBuilder = (Widget nextPage, settings) =>
        PageRouteBuilder(
          settings: settings,
  ...
  testWidgets('WHEN RM.navigate.transitionsBuilder is defined'
      'Route animation uses it'
  ...
  testWidgets('WHEN RM.navigate.onGenerateRoute defines an empty routes map'
      'THEN it throws an assertion error', (tester) async {
    expect(
      () => MaterialApp(
        home: Container(),
  ...
  testWidgets('Test route is not found', (tester) async {
    final Map<String, Widget Function(RouteData)> routes = {
      '/page1': (c) => Text(''),
      '/page2': (c) => RouteWidget(builder: (c) => Text('')),
      '/page3': (c) => RouteWidget(
        routes: {
          '/': (c) => Text(''),
          '/page31': (c) {
            return RouteWidget(builder: (c) => Text(''));
          },
        },
      ),
      '/page4': (c) => RouteWidget(
  ...
  testWidgets('Check backUntil'
    ...
    final routes = {
      '/': (c) => Text('/'),
      '/page1': (c) =>
          RouteWidget(builder: (c) => c, routes: {'/': (c) => Text('/page1')}),
      '/page2': (c) =>
          RouteWidget(builder: (c) => c, routes: {'/': (c) => Text('/page2')}),
      '/page3': (c) =>
          RouteWidget(builder: (c) => c, routes: {'/': (c) => Text('/page3')}),
    };
    final widget = _TopWidget(routers: routes);
    await tester.pumpWidget(widget);
  ...
  testWidgets('Check toReplacement'
    ...
    final routes = {
      ...
      '/page2': (c) => RouteWidget(
        builder: (c) => c,
        routes: {'/': (c) => Text('/page2'), '/page21': (c) => Text('/page21')},
      ),
      '/page3': (c) =>
          RouteWidget(builder: (c) => c, routes: {'/': (c) => Text('/page3')}),
    };
  ...
  testWidgets('Check toNamedAndRemoveUntil'
    ...
    final navigator = RM.injectNavigator(
      ...
      routes: {
        '/': (c) => Scaffold(appBar: AppBar(title: Text('/'))),
        '/page1': (c) => Scaffold(appBar: AppBar(title: Text('/page1'))),
        '/page2': (c) => Scaffold(appBar: AppBar(title: Text('/page2'))),
        '/page3': (c) => Scaffold(appBar: AppBar(title: Text('/page3'))),
      },
    );
  ...
  testWidgets('Check toNamedAndRemoveUntil functionality'
    ...
    final navigator = RM.injectNavigator(
      ...
      routes: {
        ...
        '/page1': (c) => RouteWidget(
          routes: {
            '/': (data) => Scaffold(appBar: AppBar(title: Text('/page1'))),
            '/page11': (data) =>
        ...
        '/page2': (c) => RouteWidget(
          routes: {
            '/': (data) => Scaffold(appBar: AppBar(title: Text('/page2'))),
            '/page11': (data) =>
        ...
        '/page3': (c) => RouteWidget(
          routes: {
            '/': (data) => Scaffold(appBar: AppBar(title: Text('/page3'))),
            '/page11': (data) =>
  ...
  testWidgets('test setRouteStack', (tester) async {
    ...
    _navigator.setRouteStack(
      (pages) => [
        ...
        PageSettings(name: 'new-page', child: Text('New page')),
      ],
    );
    await tester.pumpAndSettle();
  ...
  testWidgets('Global base url is updated when back is called'
    ...
    final routes = {
      ...
      '/page1': (c) => RouteWidget(
        builder: (c) => c,
        routes: {'/': (c) => Text('/page1'), '/page11': (c) => Text('/page11')},
      ),
    };
    final widget = _TopWidget(routers: routes);
    await tester.pumpWidget(widget);
  ...
  testWidgets('RouteInformationParser work as expected', (tester) async {
    ...
    _provider!.value = const RouteInformation(location: '/');
    final widget = _TopWidget(
      routers: routes,
    ...
    //
    _provider!.value = const RouteInformation(location: '/page1/page11');
    await tester.pumpAndSettle();
    ...
    _provider!.value = const RouteInformation(location: '/page1/page11?q=1');
    await tester.pumpAndSettle();
    ...
    await tester.pumpAndSettle();
    _provider!.value = const RouteInformation(location: '/page1/page11?q=2');
    await tester.pumpAndSettle();
    expect(find.text('/page11-2'), findsOneWidget);
    expect(informationParser!.info!.location, '/page1/page11?q=2');
    expect(
    ...
    _provider!.value = const RouteInformation(location: '/page1/page11?q=10');
    await tester.pumpAndSettle();
    expect(informationParser!.info!.location, '/page1/page11?q=1');
    expect(find.text('/page11-1'), findsOneWidget);
    expect(
    ...
    _provider!.value = const RouteInformation(location: '/page2?q=15');
    await tester.pumpAndSettle();
  ...
  testWidgets('test pageBuilder', (tester) async {
    final routes = {'/': (c) => Text('/'), '/login': (c) => Text('/login')};
  ...
  testWidgets('test onBack', (tester) async {
    final routes = {
      '/': (c) => Text('/'),
      '/form': (c) => Scaffold(appBar: AppBar(), body: Text('/form')),
      '/page1': (c) => Text('/page1'),
    };
  ...
  testWidgets('Text shouldUseCupertinoPage', (tester) async {
    ...
    final routes = {
      ...
      '/page1': (c) => RouteWidget(routes: {'/': (c) => Text('/page1')}),
    };
  ...
  group('redirect', () {
    ...
    testWidgets('Text global redirection', (tester) async {
      final routes = {
        ...
        '/home1': (c) => Text('/home1'),
        '/home2': (c) => Text('/home2'),
        '/home3': (c) => Text('Not reached'),
        '/home4': (c) => Text('Not reached'),
        '/home5': (c) => Text('Not reached'),
        '/page1': (c) => RouteWidget(
          builder: (c) => Builder(
            builder: (context) {
              return c;
      ...
      _provider!.value = const RouteInformation(location: '/home4');
      await tester.pumpAndSettle();
      expect(find.text('/home'), findsOneWidget);
      _provider!.value = const RouteInformation(location: '/home5');
      await tester.pumpAndSettle();
      expect(find.text('/page1'), findsOneWidget);
      expect(informationParser!.info!.location, '/page1');
      _navigator.back();
  ...
  testWidgets('Test delegateImplyLeadingToParent', (tester) async {
    final routes = {
      '/': (data) => Text('/'),
      '/page1': (data) => Scaffold(appBar: AppBar(), body: Text('/page1')),
      '/page2': (data) => RouteWidget(
        routes: {'/': (c) => Scaffold(appBar: AppBar(), body: Text('/page2'))},
      ),
      '/page3': (data) => RouteWidget(
        routes: {
          '/': (c) => RouteWidget(
            routes: {
              '/': (c) => Scaffold(appBar: AppBar(), body: Text('/page3')),
            },
          ),
        },
      ),
      '/page4': (data) => RouteWidget(
        routes: {
          '/': (c) => RouteWidget(
            ...
            routes: {
              '/': (c) => Scaffold(appBar: AppBar(), body: Text('/page4')),
            },
          ),
        },
      ),
      '/page5': (data) => RouteWidget(
        routes: {
          '/': (c) => RouteWidget(
            builder: (c) => c,
            routes: {
              '/': (c) => Scaffold(appBar: AppBar(), body: Text('/page5')),
              '/page51': (c) =>
                  Scaffold(appBar: AppBar(), body: Text('/page51')),
            },
          ),
        },
      ),
      '/page6': (data) => RouteWidget(
        builder: (c) {
          return Scaffold(appBar: AppBar(), body: Text('/page6'));
        },
      ),
    };
    final widget = _TopWidget(
  ...
  testWidgets('Check InjectedNavigator.builder works', (tester) async {
    _transitionsBuilder = RM.transitions.rightToLeft(
    ...
    final routes = {
      ...
      '/page1': (data) => RouteWidget(
        routes: {
          '/': (data) => Scaffold(appBar: AppBar(), body: Text('/page1')),
        },
      ),
      '/page2': (data) => RouteWidget(
        routes: {
          '/': (data) => Scaffold(appBar: AppBar(), body: Text('/page2')),
        },
      ),
    };
  ...
  testWidgets('Check that back is reactive', (tester) async {
    final routes = {
      ...
      '/page1/:id': (data) => RouteWidget(
        delegateImplyLeadingToParent: false,
        builder: (c) => Scaffold(
          appBar: AppBar(key: Key('AppBar/page1')),
          body: c,
        ),
        routes: {
          '/': (data) => Scaffold(
          ...
          '/page2/:id': (data) => RouteWidget(
            delegateImplyLeadingToParent: false,
            builder: (c) => Scaffold(
              appBar: AppBar(key: Key('AppBar/page2')),
              body: c,
            ),
            routes: {
              '/': (data) => Scaffold(
  ...
  testWidgets('test InjectedNavigator.onNavigate', (tester) async {
    final routes = {
      '/': (data) => Text('/'),
      '/page1': (data) => Text('/page1'),
      '/page1/page11': (data) {
  ...
  testWidgets('Text Mocking InjectedNavigator', (tester) async {
    final navigator = RM.injectNavigator(
  ...
  testWidgets('Test InjectedNavigator.toReplacement for nested routes', (
    tester,
  ) async {
    final navigator = RM.injectNavigator(
      routes: {
  ...
  testWidgets('Test InjectedNavigator.toAndRemoveUntil for nested routes', (
    tester,
  ) async {
    final navigator = RM.injectNavigator(
      routes: {
  ...
  testWidgets('Test InjectedNavigator.navigator for nested routes', (
    tester,
  ) async {
    final navigator = RM.injectNavigator(
  ...
  testWidgets('WHEN '
      ' THEN ', (tester) async {
    final navigator = RM.injectNavigator(
      routes: {'/': (data) => Text('/'), '/page1': (data) => Text('/page1')},
    );
  ...
  testWidgets('Test Navigator2 with TopStatelessWidget', (tester) async {
    final navigator = RM.injectNavigator(
      // debugPrintWhenRouted: true,
      routes: {'/': (data) => Text('/'), '/page1': (data) => Text('/page1')},
    );
    ...
    await tester.pumpWidget(
      TopAppWidget(
        ...
        onWaiting: () => Scaffold(body: Text('Waiting...')),
        onError: (err, refresh) => Scaffold(
          body: ElevatedButton(child: Text('Error'), onPressed: refresh),
        ),
        builder: (context) {
          return widget;
        },
  ...
  testWidgets('Test deep link page transition is prevented', (tester) async {
    ...
    provider.value = const RouteInformation(location: '/');
    final navigator = RM.injectNavigator(
      routes: {
        '/': (data) => const Text('/'),
    ...
    await tester.pumpWidget(widget);
    expect(find.text('/'), findsOneWidget);
    provider.value = const RouteInformation(location: '/page1');
    await tester.pump();
    expect(find.text('/'), findsNothing);
    expect(find.text('/page1'), findsOneWidget);
    await tester.pump();
  ...
  testWidgets('Test deep link page transition is prevented for nested routed'
    ...
    //
    provider.value = const RouteInformation(location: '/page1/page11');
    await tester.pump();
    expect(find.text('/'), findsNothing);
    expect(find.text('/page11'), findsOneWidget);
    await tester.pump();
    ...
    expect(find.text('/page11'), findsOneWidget);
    //
    provider.value = const RouteInformation(location: '/page1/page11/page111');
    await tester.pump();
    await tester.pump();
    expect(find.text('/page11'), findsNothing);
    expect(find.text('/page111'), findsOneWidget);
...
class _MyPage extends Page {
  ...
  Route createRoute(BuildContext context) {
    return MaterialPageRoute(builder: (c) => Text('_myPage'), settings: this);
  }
}
